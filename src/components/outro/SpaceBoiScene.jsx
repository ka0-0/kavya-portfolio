...
// Hoisted so the keyframe string and its wrapper object are allocated once, not per render
...
function SpaceBoiScene() {
  ...
  return (
    ...
    >
      ...
      <style dangerouslySetInnerHTML={CINEMATIC_STYLE} />

      {/* LAYER 1 (z-10): 3D Model Canvas (SpaceBoi) */}
      <div className="absolute inset-0 z-10 pointer-events-none">
        <LoadingPlanet scale={1.15} yOffset={0.05} isActive={isInView} />
      </div>
